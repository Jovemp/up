...
public class Util {
    ...
    public static final String URL_PADRAO = "https://murmuring-depths-61815.herokuapp.com/";
    public static final String URL_IMAGEM = "https://murmuring-depths-61815.herokuapp.com";
    public static final String URL_TOKEN = URL_PADRAO + "token";
    public static final String URL_USUARIO = URL_PADRAO + "user";
    public static final String URL_CATEGORIA = URL_PADRAO + "categoria";
    public static final String URL_SERVICO = URL_PADRAO + "servicos";
    public static final String URL_SERVICO_USU = URL_PADRAO + "servicosusu";
    public static final String ACCESS_TOKEN = "token";
    public static final String ACCESS_ID_USUARIO = "id_usuario";

    public static boolean verificaConexao(Activity context) {
        boolean conectado;
    ...
    public static boolean validarEditVazio(EditText editText, Resources resources){
        String str = editText.getText().toString().trim();
        if (str.equals("")){
            editText.setError(resources.getString(R.string.campo_obrigatorio));
    ...
    public static boolean validarSpinnerVazio(Spinner spinner, Resources resources){
        int id = spinner.getSelectedItemPosition();
        if (id == 0){
            TextView errorText = (TextView)spinner.getSelectedView();
            errorText.setError(resources.getString(R.string.campo_obrigatorio));
